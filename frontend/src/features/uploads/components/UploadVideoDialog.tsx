...
//     initMultipartUpload,
//     uploadThumbnail,
// } from "../../uploads/services/uploadService";
...
//                 const urls = await getPartUrls(api, uploadId, key, [partNumber]);
...
//                 await abortUpload(api, { uploadId, key });
//             },

//             async listParts(_file, _opts) {
//                 return [];
//             },
